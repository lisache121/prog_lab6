...
public class Server {
    ...
    private void sendResponse(ByteBuffer[] response, SocketAddress clientAddress) {
        try {
    ...
    private ByteBuffer[] serializeResponse(ResponseMessage response) {
        try {
    ...
    public CommandRequest deserialize(byte[] buf) throws IOException, ClassNotFoundException {
