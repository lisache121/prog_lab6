...
public class Dragon implements Serializable, Comparable<Dragon> {
    ...
    public Dragon(@JsonProperty("name") String name, @JsonProperty("coordinates") Coordinates coordinates, @JsonProperty("creationDate") Date date, @JsonProperty("age") int age, @JsonProperty("description") String description, @JsonProperty("color") Color color, @JsonProperty("type") DragonType type, @JsonProperty("head") DragonHead head) {
